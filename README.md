...
## Generate VCF files
VCF files are generated by combining information from your 23andMe data with the target chip list from above. Please keep in mind that this repository currently provides the v4 chip only.
